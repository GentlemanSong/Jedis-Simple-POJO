...
import com.leon.redis.common.client.SentinelRedisPoolClient;
 ...
 *
 */
public class SentinelRedisUtil {
	private static Log log = LogFactory.getLog(SentinelRedisUtil.class);
